export default async function AboutPage() {
  return (
    <>
      <div className='flex flex-col justify-center items-center [&>p]:max-w-lg [&>p]:mt-7 text-center'>
        ...
        <p>
          I created this website to solve the following main issues:
        ...
        <p>
          ...
          <ol className='list-decimal text-left mt-3 [&>li]:mb-2'>
            <li>
              All minigames has both a daily mode with one solution per day, and
              a training mode for unlimited rounds
            </li>
            <li>No ads</li>
            <li>
